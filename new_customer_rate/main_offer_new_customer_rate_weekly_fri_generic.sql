...
-- 		shopify_tiktok_protein50_orders
	...
	WHERE
		DATE_TRUNC('day', created_at, 'America/Los_Angeles')::date >= MAKE_DATE(2022, 10, 28) 
		AND DATE_TRUNC('day', created_at, 'America/Los_Angeles')::date <= MAKE_DATE(2023, 04, 13)
...
SELECT
	(DATE_TRUNC('week', date_pst + INTERVAL '3 days')::DATE - INTERVAL '3 days')::DATE AS date_week,
